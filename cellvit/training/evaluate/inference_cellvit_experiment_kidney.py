...
from cellvit.training.datasets.kidney import KidneyDataset
...
class CellViTInfExpKidney(CellViTClassifierInferenceExperiment):
...
if __name__ == "__main__":
    ...
    experiment_inferer = CellViTInfExpKidney(
